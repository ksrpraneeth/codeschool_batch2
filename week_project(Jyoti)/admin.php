...
<body style="background-image: url('shopping-cart-304843_1280.webp');">
    <div class="container-xxl">
        <div class="row col-12" style="padding-top:2%;background-color: darkcyan;position:fixed;">
            <div class="col-3" style="color: white;" id="name"><b>Welcome Admin</b></div>
            <div class="col-5"> <div class="input-group mb-3">
...
<div id="date" style=" font-size: 10px; color: white; font-weight:bold;"></div>
        ...
        <div class="row pt-3" id="itemdetails" style="background-color:darkcyan;"></div>
        <div class="row"></div>
        <!-- Modal -->
