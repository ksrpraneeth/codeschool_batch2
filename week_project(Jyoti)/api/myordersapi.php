...
$statement=$pdo->prepare("select * from placeorder ,products,address where placeorder.product_id=products.id and placeorder.user_id=address.user_id and placeorder.user_id=?");
