...
<body>
    <div class="container-fluid">
        <div class="row col-12" style="padding-top:2%;background-color: rgb(71, 222, 108);position:fixed;">
        <div class="col-2" style="font-family: 'Sofia', sans-serif;color:black;font-size:20px;">In My Cart</div>
            <div class="col-1" style="color: white;" id="name"><b>Welcome Admin</b></div>
...
<div class="col-1"><button type="button" id="allorders"class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Orders</button></div>
...
<div id="date" style=" font-size: 10px; color: white; font-weight:bold;"></div>
        ...
        <div class="row pt-3" id="itemdetails" style="background-color:rgb(95, 237, 130);font-size: 16px; font-weight:bold;"></div>
        <div class="row"></div>
        <!-- Modal -->
