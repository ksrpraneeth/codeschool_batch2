...
<body>
    <div class="container-fluid">
        ...
        <div class="row header2">
            ...
            <div class="col-md-1" style="margin-top:50px"><a href="myOrder.html" style="text-decoration: none;color:black;">My Order</a></div>
            ...
            <div class="col-md-1" style="margin-top:50px"><a href="logout.php" style="text-decoration: none;color:black;">LOGOUT</a></div>
