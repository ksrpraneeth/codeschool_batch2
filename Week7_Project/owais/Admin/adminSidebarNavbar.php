...
<head>
    ...
    <title>Admin Dashboard Pixel Bank</title>
...
<body>
    <div id="mySidenav" class="sidenav">
        <ul>
            <li><a href="adminDashboard.php">Dash board</a></li>
            <li><a href="wallet.php">Wallet</a></li>
            <li><a href="adminTransfer.php">Transfer</a></li>
            <li><a href="customerAccount.php">Customer Account</a></li>
            <li><a href="verify.php">Verify Account</a></li>
            <li><a href="#">Card Requests</a></li>
            ...
            <div class="row">
               ...
               <div class="col-xs-2 col-sm-2  justify-content-end user">
                    <div class="dropdown">
                        ...
                        <li><a class="dropdown-item" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" color="#5EA662" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
