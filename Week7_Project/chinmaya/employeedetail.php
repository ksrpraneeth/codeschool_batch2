  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <div class="container editbody">

        <div class="row">
          <div class="col-4"> Sur Name</div>
          <div class="col-6"><input class="form-control" type="text" id="editEmployeeSurename" value=""></div>
        </div>

        <div class="row mt-2">
          <div class="col-4">First Name</div>
          <div class="col-6"><input class="form-control" type="text" id="editEmployeeFirstname" value=""></div>
        </div>


        <div class="row mt-2">
          <div class="col-4">Last Name</div>
          <div class="col-6"><input class="form-control" type="text" id="editEmployeeLastname" value=""></div>
        </div>

        <div class="row mt-2">
          <div class="col-4">Date of Joining</div>
          <div class="col-6"><input class="form-control" type="date" id="editEmployeeDoj" value=""></div>
        </div>

        <div class="row mt-2">
          <div class="col-4">Date of Birth</div>
          <div class="col-6"><input class="form-control" type="date" id="editEmployeeDob" value=""></div>
        </div>

        <div class="row mt-2">
          <div class="col-4">Gender</div>
          <div class="col-6">
          <select class="form-select" aria-label="Default select example" id=editemployeeGender>
        ...
        <div class="row mt-2">
          ...
          <div class="col-6">
          <select class="form-select" aria-label="Default select example" id=editemployeeworkingstatus>
        ...
        <div class="row mt-2">
          <div class="col-4">Location</div>
          <div class="col-6">
          <select class="form-select" aria-label="Default select example" id=editemployeeLocation>
        ...
        <div class="row mt-2">
          <div class="col-4">Designation</div>
          <div class="col-6">
          <select class="form-select" aria-label="Default select example" id=editemployeeDesignation>
        ...
        <!-- <div class="row mt-2">
          <div class="col-4">Gross salary</div>
          <div class="col-6"><input class="form-control" type="number" id="editEmployeeGross" value=""></div>
        </div> -->
      ...
      <div class="modal-footer" id="modalFoter">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
