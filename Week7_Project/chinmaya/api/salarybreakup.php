...
try {
    ...
    $statement1->execute([$employeeid,$_POST['salaryid'],$_POST['month'],$_POST['year']]);
    ...
    $statement2->execute([$employeeid,$_POST['salaryid']]);
    ...
    $statement3->execute([$employeeid,$_POST['salaryid']]);
