...
<body>
    <div class="container-fluid">
        ...
        <div class="row header2">
            ...
            <div class="col-md-1" style="margin-top:50px" id="logout">LOGOUT</div>
            ...
            success: function (response) {
                ...
                if (response.status == true) {
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="offset-md-2 col-md-6"><button type="button" class="btn btn-primary" onclick="addToCart()" style="margin-left:25px;">ADD TO
                                    CART</button></div>
